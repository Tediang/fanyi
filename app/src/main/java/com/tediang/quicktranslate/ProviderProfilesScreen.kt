    ...
    Card(
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                ...
                TextButton(onClick = onTest, enabled = !testing) { Text(if (testing) "测试中…" else "测试连接") }
...
internal fun ProviderProfileEditorScreen(
    ...
    val validation = validateProfileDraft(name, baseUrl, model, existingNames, headers)
...
private data class ProfileValidation(
    ...
    val isValid: Boolean get() = name == null && baseUrl == null && model == null && headers == null
}
